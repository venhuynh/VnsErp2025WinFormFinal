...
-- Phiên bản hiện tại: 2.0.2.1 (từ AssemblyVersion trong AssemblyInfo.cs)
...
-- Phiên bản trong AssemblyInfo.cs: 2.0.2.1
-- =============================================

DECLARE @NewVersion NVARCHAR(50) = N'2.0.2.1';  -- ✅ Phiên bản từ AssemblyInfo.cs (AssemblyVersion: 2.0.2.1)
DECLARE @ReleaseDate DATETIME = GETDATE();      -- ⚠️ THAY ĐỔI: Ngày phát hành (hoặc dùng GETDATE() cho ngày hiện tại)
DECLARE @Description NVARCHAR(500) = N'Phiên bản 2.0.2.1 - Sửa lỗi nhập xuất';  -- ⚠️ THAY ĐỔI: Mô tả ngắn
DECLARE @ReleaseNote NVARCHAR(1000) = N'Chi tiết các thay đổi trong phiên bản 2.0.2.1:
- Sửa lỗi nhập xuất
- Cải thiện hiệu suất và ổn định hệ thống';  -- ⚠️ THAY ĐỔI: Ghi chú phát hành chi tiết
