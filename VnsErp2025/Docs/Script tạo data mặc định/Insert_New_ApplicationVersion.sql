...
-- Phiên bản hiện tại: 2.0.1.0 (từ AssemblyVersion trong AssemblyInfo.cs)
...
-- Phiên bản trong AssemblyInfo.cs: 2.0.1.0
-- =============================================

DECLARE @NewVersion NVARCHAR(50) = N'2.0.1.0';  -- ✅ Phiên bản từ AssemblyInfo.cs (AssemblyVersion: 2.0.1.0)
DECLARE @ReleaseDate DATETIME = GETDATE();      -- ⚠️ THAY ĐỔI: Ngày phát hành (hoặc dùng GETDATE() cho ngày hiện tại)
DECLARE @Description NVARCHAR(500) = N'Phiên bản 2.0.1.0 - Cập nhật mới';  -- ⚠️ THAY ĐỔI: Mô tả ngắn
DECLARE @ReleaseNote NVARCHAR(1000) = N'Chi tiết các thay đổi trong phiên bản 2.0.1.0:
- Cập nhật phiên bản lên 2.0.1.0
