-- =============================================
-- Migration Script: Add Discount Columns to StockInOutDetail Table
-- Description: Thêm các cột chiết khấu vào bảng StockInOutDetail
-- Columns:
...
BEGIN TRY
    PRINT '========================================';
    PRINT 'Bắt đầu migration: Thêm cột chiết khấu cho StockInOutDetail';
    PRINT '========================================';
    PRINT '';
    ...
    IF NOT EXISTS (SELECT 1 FROM sys.columns 
                   WHERE object_id = OBJECT_ID(N'dbo.StockInOutDetail') 
                   AND name = 'DiscountPercentage')
    BEGIN
        ALTER TABLE dbo.StockInOutDetail
    ...
    WHERE c.object_id = OBJECT_ID(N'dbo.StockInOutDetail')
