...
namespace DTO.Inventory.StockOut.XuatBaoHanh;
...
/// </summary>
public class XuatBaoHanhDetailDto
{
...
/// </summary>
public static class XuatBaoHanhDetailDtoConverter
{
    ...
    /// <returns>XuatBaoHanhDetailDto</returns>
    public static XuatBaoHanhDetailDto ToXuatBaoHanhDetailDto(this Dal.DataContext.StockInOutDetail entity)
    {
        if (entity == null) return null;

        var dto = new XuatBaoHanhDetailDto
        {
            Id = entity.Id,
    ...
    public static List<XuatBaoHanhDetailDto> ToXuatBaoHanhDetailDtoList(this IEnumerable<StockInOutDetail> entities)
    {
        return entities == null 
            ? [] 
            : entities.Select(entity => entity.ToXuatBaoHanhDetailDto()).Where(dto => dto != null).ToList();
    }
