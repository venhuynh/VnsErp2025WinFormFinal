...
namespace DTO.Inventory.StockOut.XuatThietBiChoThueMuon;


/// <summary>
/// Data Transfer Object cho chi tiết phiếu xuất thiết bị cho thuê - mượn
/// Dùng cho GridControl và truyền dữ liệu giữa Service ↔ WinForms
/// Map với bảng StockInOutDetail trong database
/// </summary>
public class XuatThietBiChoThueMuonDetailDto
{
...
/// <summary>
/// Converter giữa StockInOutDetail entity và XuatThietBiChoThueMuonDetailDto
/// </summary>
public static class XuatThietBiChoThueMuonDetailDtoConverter
{
    #region Entity to DTO

    /// <summary>
    /// Chuyển đổi StockInOutDetail entity thành XuatThietBiChoThueMuonDetailDto    
    /// </summary>
    /// <param name="entity">StockInOutDetail entity</param>
    /// <returns>XuatThietBiChoThueMuonDetailDto</returns>
    public static XuatThietBiChoThueMuonDetailDto ToXuatThietBiChoThueMuonDetailDto(this Dal.DataContext.StockInOutDetail entity)
    {
        if (entity == null) return null;

        var dto = new XuatThietBiChoThueMuonDetailDto
        {
            Id = entity.Id,
    ...
    /// <summary>
    /// Chuyển đổi danh sách StockInOutDetail entities thành danh sách XuatThietBiChoThueMuonDetailDto
    /// </summary>
    /// <param name="entities">Danh sách StockInOutDetail entities</param>
    /// <returns>Danh sách XuatThietBiChoThueMuonDetailDto</returns>
    public static List<XuatThietBiChoThueMuonDetailDto> ToXuatThietBiChoThueMuonDetailDtoList(this IEnumerable<Dal.DataContext.StockInOutDetail> entities)
    {
        if (entities == null) return new List<XuatThietBiChoThueMuonDetailDto>();

        return entities.Select(entity => entity.ToXuatThietBiChoThueMuonDetailDto()).Where(dto => dto != null).ToList();
    }
