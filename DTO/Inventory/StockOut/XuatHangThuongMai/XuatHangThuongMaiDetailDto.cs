...
/// <summary>
/// Converter giữa StockInOutDetail entity và XuatHangThuongMaiDetailDto
/// </summary>
public static class XuatHangThuongMaiDetailDtoConverter
{
    #region Entity to DTO

    /// <summary>
    /// Chuyển đổi StockInOutDetail entity thành XuatHangThuongMaiDetailDto
    /// </summary>
    /// <param name="entity">StockInOutDetail entity</param>
    /// <returns>XuatHangThuongMaiDetailDto</returns>
    public static XuatHangThuongMaiDetailDto ToXuatHangThuongMaiDetailDto(this Dal.DataContext.StockInOutDetail entity)
    {
        if (entity == null) return null;

        var dto = new XuatHangThuongMaiDetailDto
        {
            Id = entity.Id,
            ...
            TinhTrangSanPham = entity.GhiChu ?? "Bình thường" // Lấy từ trường GhiChu trong entity
        };
    ...
    /// <summary>
    /// Chuyển đổi danh sách StockInOutDetail entities thành danh sách XuatHangThuongMaiDetailDto
    /// </summary>
    /// <param name="entities">Danh sách StockInOutDetail entities</param>
    /// <returns>Danh sách XuatHangThuongMaiDetailDto</returns>
    public static List<XuatHangThuongMaiDetailDto> ToXuatHangThuongMaiDetailDtoList(this IEnumerable<Dal.DataContext.StockInOutDetail> entities)
    {
        if (entities == null) return new List<XuatHangThuongMaiDetailDto>();

        return entities.Select(entity => entity.ToXuatHangThuongMaiDetailDto()).ToList();
    }
