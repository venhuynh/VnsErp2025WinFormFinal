...
/// <summary>
/// Converter giữa StockInOutDetail entity và XuatLuuChuyenKhoDetailDto
/// </summary>
public static class XuatLuuChuyenKhoConverter
{
    #region Entity to DTO

    /// <summary>
    /// Chuyển đổi StockInOutDetail entity thành XuatLuuChuyenKhoDetailDto
    /// </summary>
    /// <param name="entity">StockInOutDetail entity</param>
    /// <returns>XuatLuuChuyenKhoDetailDto</returns>
    public static XuatLuuChuyenKhoDetailDto ToXuatLuuChuyenKhoDetailDto(this Dal.DataContext.StockInOutDetail entity)
    {
        if (entity == null) return null;

        var dto = new XuatLuuChuyenKhoDetailDto
        {
            Id = entity.Id,
    ...
    /// <summary>
    /// Chuyển đổi danh sách StockInOutDetail entities thành danh sách XuatLuuChuyenKhoDetailDto
    /// </summary>
    /// <param name="entities">Danh sách StockInOutDetail entities</param>
    /// <returns>Danh sách XuatLuuChuyenKhoDetailDto</returns>
    public static List<XuatLuuChuyenKhoDetailDto> ToXuatLuuChuyenKhoDetailDtoList(this IEnumerable<StockInOutDetail> entities)
    {
        if (entities == null) return new List<XuatLuuChuyenKhoDetailDto>();

        return entities.Select(entity => entity.ToXuatLuuChuyenKhoDetailDto()).Where(dto => dto != null).ToList();
    }
