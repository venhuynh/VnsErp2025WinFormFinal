...
namespace DTO.Inventory.StockOut.XuatLapRap
{
    ...
    public class XuatLapRapDetailDto
    {
        ...
        public string FullNameHtml
        {
            get
            {
                ...
                {
                    html +=
                        $"<size=9><color='#757575'>Số lượng xuất:</color></size> <size=10><color='#212121'><b>{StockOutQty:N2}</b></color></size>";
                }
    ...
    /// <summary>
    /// Converter giữa StockInOutDetail entity và XuatLapRapDetailDto
    /// </summary>
    public static class XuatLapRapConverter
    {
        #region Entity to DTO

        /// <summary>
        /// Chuyển đổi StockInOutDetail entity thành XuatLapRapDetailDto
        /// </summary>
        /// <param name="entity">StockInOutDetail entity</param>
        /// <returns>XuatLapRapDetailDto</returns>
        public static XuatLapRapDetailDto ToXuatLapRapDetailDto(this StockInOutDetail entity)
        {
            if (entity == null) return null;

            var dto = new XuatLapRapDetailDto
            {
                Id = entity.Id,
        ...
        /// <summary>
        /// Chuyển đổi danh sách StockInOutDetail entities thành danh sách XuatLapRapDetailDto
        /// </summary>
        /// <param name="entities">Danh sách StockInOutDetail entities</param>
        /// <returns>Danh sách XuatLapRapDetailDto</returns>
        public static List<XuatLapRapDetailDto> ToXuatLapRapDetailDtoList(this IEnumerable<StockInOutDetail> entities)
        {
            List<XuatLapRapDetailDto> list = [];
            foreach (var entity in entities)
            {
                var dto = entity.ToXuatLapRapDetailDto();
