...
namespace DTO.Inventory.StockIn.NhapLapRap
{
    ...
    public class NhapLapRapDetailDto
    {
        ...
        public string FullNameHtml
        {
            get
            {
                ...
                // - Số lượng: font nhỏ hơn, màu xám cho label, đen cho value
                ...
                if (!string.IsNullOrWhiteSpace(unitCode) || !string.IsNullOrWhiteSpace(unitName))
                {
                    ...
                    html +=
                        $"<size=9><color='#757575'>Đơn vị tính:</color></size> <size=10><color='#212121'><b>{unitDisplay}</b></color></size><br>";
                }
                ...
                {
                    html +=
                        $"<size=9><color='#757575'>Số lượng nhập:</color></size> <size=10><color='#212121'><b>{StockInQty:N2}</b></color></size>";
                }
    ...
    /// <summary>
    /// Converter giữa StockInOutDetail entity và NhapLapRapDetailDto
    /// </summary>
    public static class NhapLapRapConverter
    {
        #region Entity to DTO

        /// <summary>
        /// Chuyển đổi StockInOutDetail entity thành NhapLapRapDetailDto
        /// </summary>
        /// <param name="entity">StockInOutDetail entity</param>
        /// <returns>NhapLapRapDetailDto</returns>
        public static NhapLapRapDetailDto ToNhapLapRapDetailDto(this StockInOutDetail entity)
        {
            if (entity == null) return null;

            var dto = new NhapLapRapDetailDto
            {
                Id = entity.Id,
        ...
        /// <summary>
        /// Chuyển đổi danh sách StockInOutDetail entities thành danh sách NhapLapRapDetailDto
        /// </summary>
        /// <param name="entities">Danh sách StockInOutDetail entities</param>
        /// <returns>Danh sách NhapLapRapDetailDto</returns>
        public static List<NhapLapRapDetailDto> ToNhapLapRapDetailDtoList(this IEnumerable<StockInOutDetail> entities)
        {
            List<NhapLapRapDetailDto> list = [];
            foreach (var entity in entities)
            {
                var dto = entity.ToNhapLapRapDetailDto();
