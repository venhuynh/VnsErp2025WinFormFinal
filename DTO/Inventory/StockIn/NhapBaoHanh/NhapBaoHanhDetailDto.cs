...
/// </summary>
public class NhapBaoHanhDetailDto
{
...
/// </summary>
public static class NhapBaoHanhDetailDtoConverter
{
    ...
    /// <returns>NhapBaoHanhDetailDto</returns>
    public static NhapBaoHanhDetailDto ToNhapBaoHanhDetailDto(this Dal.DataContext.StockInOutDetail entity)
    {
        if (entity == null) return null;

        var dto = new NhapBaoHanhDetailDto
        {
            Id = entity.Id,
    ...
    public static List<NhapBaoHanhDetailDto> ToNhapBaoHanhDetailDtoList(this IEnumerable<StockInOutDetail> entities)
    {
        if (entities == null) return [];

        return entities.Select(entity => entity.ToNhapBaoHanhDetailDto()).Where(dto => dto != null).ToList();
    }
