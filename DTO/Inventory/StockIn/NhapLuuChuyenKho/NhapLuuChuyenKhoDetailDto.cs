...
/// </summary>
public class NhapLuuChuyenKhoDetailDto
{
...
/// </summary>
public static class NhapLuuChuyenKhoConverter
{
    ...
    public static NhapLuuChuyenKhoDetailDto ToNhapLuuChuyenKhoDetailDto(this Dal.DataContext.StockInOutDetail entity)
    {
        if (entity == null) return null;

        var dto = new NhapLuuChuyenKhoDetailDto
        {
            Id = entity.Id,
    ...
    public static List<NhapLuuChuyenKhoDetailDto> ToNhapLuuChuyenKhoDetailDtoList(this IEnumerable<StockInOutDetail> entities)
    {
        if (entities == null) return new List<NhapLuuChuyenKhoDetailDto>();

        return entities.Select(entity => entity.ToNhapLuuChuyenKhoDetailDto()).Where(dto => dto != null).ToList();
    }
