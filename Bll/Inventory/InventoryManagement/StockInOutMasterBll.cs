...
namespace Bll.Inventory.InventoryManagement
{
    ...
    public class StockInOutMasterBll
    {
        ...
        /// <summary>
        /// Lấy danh sách các StockInOutMaster trong khoảng thời gian từ fromDate đến toDate
        /// </summary>
        ...
        {
            return GetDataAccess().GetStockInOutMasterHistoryDtoByDates(fromDate, toDate);
        }
        ...
        public void Delete(Guid id)
        {
            try
            {
                ...
                using var context =
                    new VnsErp2025DataContext(ApplicationStartupManager.Instance.GetGlobalConnectionString());
