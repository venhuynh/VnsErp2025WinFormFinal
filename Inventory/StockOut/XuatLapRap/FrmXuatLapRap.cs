    ...
    /// </summary>
        ...
        private async Task<bool> SaveDataAsync()
        {
            try
            {
                ...
                var detailDtos = ucXuatLapRapDetailDto1.GetDetails();
                ...
                else
                {
                    ...
                    _logger.Info("SaveDataAsync: Updating existing warranty input voucher, Id={0}", _currentStockOutId);
                    masterDto.Id = _currentStockOutId;
