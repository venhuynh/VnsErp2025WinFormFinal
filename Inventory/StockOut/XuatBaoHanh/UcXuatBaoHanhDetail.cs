...
public partial class UcXuatBaoHanhDetail : DevExpress.XtraEditors.XtraUserControl
{
    ...
    private void InitializeControl()
    {
        try
        {
            ...
            xuatBaoHanhDetailDtoBindingSource.DataSource = new List<XuatBaoHanhDetailDto>();
    ...
    public (decimal totalQuantity, decimal totalAmount, decimal totalVat, decimal totalAmountIncludedVat) CalculateTotals()
    {
        try
        {
            var details = Enumerable.Cast<XuatBaoHanhDetailDto>(xuatBaoHanhDetailDtoBindingSource).ToList();
    ...
    public void ClearData()
    {
        ...
        {
            xuatBaoHanhDetailDtoBindingSource.DataSource = new List<XuatBaoHanhDetailDto>();
            xuatBaoHanhDetailDtoBindingSource.ResetBindings(false);
    ...
    public Task LoadDataAsyncForEdit(Guid stockInOutMasterId)
    {
        try
        {
            ...
            var detailDtos = detailEntities
                .Where(e => e != null)
                .Select(entity => entity.ToXuatBaoHanhDetailDto()) // Extension method từ NhapBaoHanh namespace
                .Where(dto => dto != null)
                .ToList();
    ...
    public void SetStockInMasterId(Guid stockInMasterId)
    {
        try
        {
            ...
            var details = xuatBaoHanhDetailDtoBindingSource.Cast<XuatBaoHanhDetailDto>().ToList();
    ...
    /// </summary>
    private void XuatBaoHanhDetailDtoGridView_CustomDrawRowIndicator(object sender, DevExpress.XtraGrid.Views.Grid.RowIndicatorCustomDrawEventArgs e)
    {
    ...
    /// </summary>
    private void XuatBaoHanhDetailDtoGridView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
    {
        try
        {
            ...
            if (fieldName == "ProductVariantId")
            {
                ...
                var selectedVariant = Enumerable.Cast<ProductVariantListDto>(productVariantListDtoBindingSource)
    ...
    /// </summary>
    private void XuatBaoHanhDetailDtoGridView_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
    {
        try
        {
    ...
    /// </summary>
    private void XuatBaoHanhDetailDtoGridView_ValidatingEditor(object sender, DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
    {
        try
        {
    ...
    /// </summary>
    private void XuatBaoHanhDetailDtoGridView_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
    {
        try
        {
    ...
    /// </summary>
    /// <param name="details">Danh sách XuatBaoHanhDetailDto chứa ProductVariantId</param>
    private async Task LoadProductVariantsByIdsAsync(List<XuatBaoHanhDetailDto> details)
    {
        try
        {
    ...
    /// </summary>
    private async void LoadDetails(List<XuatBaoHanhDetailDto> details)
    {
        try
        {
            ...
            xuatBaoHanhDetailDtoBindingSource.DataSource = details;
            xuatBaoHanhDetailDtoBindingSource.ResetBindings(false);
    ...
    private void HandleProductVariantIdChange(DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
    {
        ...
        if (rowHandle < 0)
        {
            ...
            XuatBaoHanhDetailDtoGridView.SetFocusedRowCellValue("ProductVariantName", $"{selectedVariant.VariantFullName}");
        ...
        else
        {
            ...
            if (XuatBaoHanhDetailDtoGridView.GetRow(rowHandle) is XuatBaoHanhDetailDto rowData)
            {
                rowData.ProductVariantId = selectedVariant.Id;
                rowData.ProductVariantCode = selectedVariant.VariantCode;
