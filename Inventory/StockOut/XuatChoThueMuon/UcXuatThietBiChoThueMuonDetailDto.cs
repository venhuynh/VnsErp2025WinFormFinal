...
public partial class UcXuatThietBiChoThueMuonDetailDto : DevExpress.XtraEditors.XtraUserControl
{
    ...
    private void InitializeControl()
    {
        try
        {
            ...
            xuatThietBiChoThueMuonDetailDtoBindingSource.DataSource = new List<XuatThietBiChoThueMuonDetailDto>();
    ...
    private void InitializeEvents()
    {
        ...
        XuatThietBiChoThueMuonDetailDtoGridView.CellValueChanged += StockOutDetailDtoGridView_CellValueChanged;

        // Event khi thêm/xóa dòng để cập nhật LineNumber
        XuatThietBiChoThueMuonDetailDtoGridView.InitNewRow += StockOutDetailDtoGridView_InitNewRow;
        XuatThietBiChoThueMuonDetailDtoGridView.RowDeleted += StockOutDetailDtoGridView_RowDeleted;

        // Event khi validate cell và row
        XuatThietBiChoThueMuonDetailDtoGridView.ValidateRow += StockOutDetailDtoGridView_ValidateRow;
        XuatThietBiChoThueMuonDetailDtoGridView.ValidatingEditor += StockOutDetailDtoGridView_ValidatingEditor;

        // Event custom draw row indicator
        XuatThietBiChoThueMuonDetailDtoGridView.CustomDrawRowIndicator += StockOutDetailDtoGridView_CustomDrawRowIndicator;

        // Event xử lý phím tắt cho GridView (Insert, Delete, Enter)
        XuatThietBiChoThueMuonDetailDtoGridView.KeyDown += StockOutDetailDtoGridView_KeyDown;
    ...
    public List<StockInOutDetail> GetDetails()
    {
        try
        {
            ...
            foreach (var item in xuatThietBiChoThueMuonDetailDtoBindingSource)
            {
                if (item is not XuatThietBiChoThueMuonDetailDto detailDto) continue;
    ...
    public void ClearData()
    {
        ...
        {
            xuatThietBiChoThueMuonDetailDtoBindingSource.DataSource = new List<XuatThietBiChoThueMuonDetailDto>();
            xuatThietBiChoThueMuonDetailDtoBindingSource.ResetBindings(false);
    ...
    public Task LoadDataAsyncForEdit(Guid stockInOutMasterId)
    {
        try
        {
            ...
            var detailDtos = detailEntities
                .Where(e => e != null)
                .Select(entity => entity.ToXuatThietBiChoThueMuonDetailDto()) // Static method từ XuatThietBiChoThueMuon namespace
                .Where(dto => dto != null)
                .ToList();
    ...
    public void SetStockOutMasterId(Guid stockOutMasterId)
    {
        try
        {
            ...
            var details = xuatThietBiChoThueMuonDetailDtoBindingSource.Cast<XuatThietBiChoThueMuonDetailDto>().ToList();
    ...
    {
        GridViewHelper.CustomDrawRowIndicator(XuatThietBiChoThueMuonDetailDtoGridView, e);
    }
    ...
    private void StockOutDetailDtoGridView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
    {
        try
        {
            ...
            if (XuatThietBiChoThueMuonDetailDtoGridView.GetRow(rowHandle) is not XuatThietBiChoThueMuonDetailDto rowData)
            {
            ...
            XuatThietBiChoThueMuonDetailDtoGridView.RefreshRow(rowHandle);
        }
        catch (Exception ex)
        {
    ...
    private void StockOutDetailDtoGridView_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
    {
        try
        {
            var rowData = XuatThietBiChoThueMuonDetailDtoGridView.GetRow(e.RowHandle) as XuatThietBiChoThueMuonDetailDto;
            if (rowData == null)
            {
    ...
    private void StockOutDetailDtoGridView_ValidatingEditor(object sender, DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
    {
        try
        {
            var column = XuatThietBiChoThueMuonDetailDtoGridView.FocusedColumn;
            var fieldName = column?.FieldName;
            var rowHandle = XuatThietBiChoThueMuonDetailDtoGridView.FocusedRowHandle;
    ...
    private void StockOutDetailDtoGridView_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
    {
        try
        {
            var rowData = e.Row as XuatThietBiChoThueMuonDetailDto;
            if (rowData == null)
            {
    ...
    private void StockOutDetailDtoGridView_KeyDown(object sender, KeyEventArgs e)
    {
        try
        {
            var gridView = XuatThietBiChoThueMuonDetailDtoGridView;
    ...
    /// </summary>
    /// <param name="details">Danh sách XuatThietBiChoThueMuonDetailDto chứa ProductVariantId</param>
    private async Task LoadProductVariantsByIdsAsync(List<XuatThietBiChoThueMuonDetailDto> details)
    {
        try
        {
    ...
    /// </summary>
    private async void LoadDetails(List<XuatThietBiChoThueMuonDetailDto> details)
    {
        try
        {
            details ??= new List<XuatThietBiChoThueMuonDetailDto>();
            ...
            xuatThietBiChoThueMuonDetailDtoBindingSource.DataSource = details;
            xuatThietBiChoThueMuonDetailDtoBindingSource.ResetBindings(false);
    ...
    private void RecalculateAll()
    {
        try
        {
            ...
            XuatThietBiChoThueMuonDetailDtoGridView.RefreshData();
    ...
    private void HandleProductVariantIdChange(DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
    {
        ...
        if (rowHandle < 0)
        {
            ...
            XuatThietBiChoThueMuonDetailDtoGridView.SetFocusedRowCellValue("ProductVariantName", $"{selectedVariant.VariantFullNameHtml}");
        ...
        else
        {
            ...
            if (XuatThietBiChoThueMuonDetailDtoGridView.GetRow(rowHandle) is XuatThietBiChoThueMuonDetailDto rowData)
            {
                rowData.ProductVariantId = selectedVariant.Id;
                rowData.ProductVariantCode = selectedVariant.VariantCode;
    ...
    /// <summary>
    /// Map XuatThietBiChoThueMuonDetailDto sang StockInOutDetail entity
    /// </summary>
    private StockInOutDetail MapDetailDtoToEntity(XuatThietBiChoThueMuonDetailDto dto)
    {
        ...
        return new StockInOutDetail
        {
            ...
            StockInQty = 0, // XuatThietBiChoThueMuon chỉ có xuất, không có nhập
            StockOutQty = dto.StockOutQty,
            UnitPrice = 0, // XuatThietBiChoThueMuon không có giá
            Vat = 0, // XuatThietBiChoThueMuon không có VAT
            VatAmount = 0, // XuatThietBiChoThueMuon không có VAT
            TotalAmount = 0, // XuatThietBiChoThueMuon không có tổng tiền
