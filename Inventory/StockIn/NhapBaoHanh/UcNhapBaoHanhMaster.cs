...
public partial class UcNhapBaoHanhMaster : XtraUserControl
{
    ...
    private bool ValidateInput()
    {
        try
        {
            ...
            // Nhà cung cấp/Khách hàng không được để trống
            if (SupplierNameSearchLookupEdit.EditValue is not Guid supplierId || supplierId == Guid.Empty)
            {
                dxErrorProvider1.SetError(SupplierNameSearchLookupEdit, "Nhà cung cấp hoặc khách hàng không được để trống");
                return false;
            }
    ...
    public StockInOutMasterForUIDto GetDto()
    {
        try
        {
            ...
            if (warehouseId != Guid.Empty)
            {
                ...
                var warehouse = WarehouseNameSearchLookupEdit.GetSelectedDataRow() as DTO.MasterData.Company.CompanyBranchLookupDto;
                if (warehouse == null && companyBranchLookupDtoBindingSource.DataSource is System.Collections.IList warehouseList)
                {
                    warehouse = warehouseList.Cast<DTO.MasterData.Company.CompanyBranchLookupDto>()
    ...
    public async Task LoadDataAsync(Guid stockInOutMasterId)
    {
        try
        {
            ...
            var masterEntity = _stockInOutBll.GetStockInOutMasterForUIDtoById(stockInOutMasterId);
            ...
            StockInDateDateEdit.EditValue = masterEntity.StockOutDate;
            StockInNumberTextEdit.EditValue = masterEntity.VoucherNumber;
            ...
            SupplierNameSearchLookupEdit.EditValue = masterEntity.CustomerId;
        }
        catch (Exception ex)
        {
    ...
    private void GenerateStockInNumber(DateTime stockInDate)
    {
        try
        {
            ...
            var loaiNhapXuatKho = (LoaiNhapXuatKhoEnum)LoaiNhapXuatKhoEnum.NhapHangBaoHanh;
