            ...
            try
            {
                ...
                else
                {
                    ...
                    if (_hasUnsavedChanges)
                    {
                        ...
                        if (MsgBox.ShowYesNo(
                                "Phiếu nhập hàng bảo hành chưa được lưu. Bạn có muốn lưu trước khi in không?",
                                "Xác nhận",
                                this))
                        {
                    ...
                    else
                    {
                        ...
                        MsgBox.ShowWarning(
                            "Vui lòng nhập và lưu phiếu nhập hàng bảo hành trước khi in.",
                            "Cảnh báo",
                            this);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (_hasUnsavedChanges)
                    {
                        // Hỏi người dùng có muốn lưu trước không
                        if (MsgBox.ShowYesNo(
                                "Phiếu nhập hàng bảo hành chưa được lưu. Bạn có muốn lưu trước khi nhập bảo hành không?",
                                "Xác nhận",
                                this))
                        {
                            // Gọi nút Lưu để lưu phiếu
                    ...
                    else
                    {
                        // Không có thay đổi chưa lưu và chưa có ID - yêu cầu lưu
                        MsgBox.ShowError(
                            "Vui lòng nhập và lưu phiếu nhập hàng bảo hành trước khi nhập bảo hành.",
                            "Lỗi",
                            this);
