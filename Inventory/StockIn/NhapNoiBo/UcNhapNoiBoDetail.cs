...
public partial class UcNhapNoiBoDetail : DevExpress.XtraEditors.XtraUserControl
{
    ...
    private void StockInDetailDtoGridView_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
    {
        try
        {
            ...
            if (NhapNoiBoDetailDtoGridView.GetRow(rowHandle) is not StockInOutDetailForUIDto rowData)
            {
    ...
    private void StockInDetailDtoGridView_InitNewRow(object sender, DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs e)
    {
        try
        {
            if (NhapNoiBoDetailDtoGridView.GetRow(e.RowHandle) is not StockInOutDetailForUIDto rowData)
            {
    ...
    private void HandleProductVariantIdChange(DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
    {
        ...
        if (rowHandle < 0)
        {
            ...
            NhapNoiBoDetailDtoGridView.SetFocusedRowCellValue("ProductVariantName", $"{selectedVariant.VariantFullName}");
        ...
        else
        {
            ...
            if (NhapNoiBoDetailDtoGridView.GetRow(rowHandle) is StockInOutDetailForUIDto rowData)
            {
                rowData.ProductVariantId = selectedVariant.Id;
                rowData.ProductVariantCode = selectedVariant.VariantCode;
