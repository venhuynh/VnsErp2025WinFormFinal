...
public partial class InPhieuNhapXuatNoiBo : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public InPhieuNhapXuatNoiBo(Guid voucherId) : this()
    {
        LoadData(voucherId);
    }
