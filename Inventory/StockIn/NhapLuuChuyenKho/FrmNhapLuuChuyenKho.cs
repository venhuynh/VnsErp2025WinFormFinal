...
public partial class FrmNhapLuuChuyenKho : DevExpress.XtraEditors.XtraForm
{
    ...
    public FrmNhapLuuChuyenKho(Guid stockInOutMaster)
    {
        InitializeComponent();
        Load += FrmNhapNoiBo_Load;
    ...
    private async void FrmNhapNoiBo_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (_currentStockInOutMaster != Guid.Empty)
            {
                ...
                await ucNhapLuuChuyenKhoMaster1.LoadDataAsync(_currentStockInOutMaster);
                await ucNhapLuuChuyenKhoDetail1.LoadDataAsyncForEdit(_currentStockInOutMaster);
            }
            else
            {
    ...
    private void SetupEvents()
    {
        try
        {
            ...
            ucNhapLuuChuyenKhoDetail1.DetailDataChanged += UcNhapNoiBoDetail1_DetailDataChanged;
    ...
    private async void ReloadDataSourceBarButtonItem_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
    {
        try
        {
            ...
            try
            {
                ...
                await Task.WhenAll(
                    ucNhapLuuChuyenKhoMaster1.LoadLookupDataAsync(),
                    ucNhapLuuChuyenKhoDetail1.ReloadProductVariantDataSourceAsync()
                );
    ...
    private void ResetForm()
    {
        try
        {
            ...
            ucNhapLuuChuyenKhoMaster1.ClearData();

            // Clear detail control
            ucNhapLuuChuyenKhoDetail1.ClearData();

            // Reset tổng về 0
            ucNhapLuuChuyenKhoMaster1.UpdateTotals(0, 0, 0, 0);
    ...
    private async Task<bool> SaveDataAsync()
    {
        try
        {
            ...
            var masterDto = ucNhapLuuChuyenKhoMaster1.GetDto();
            if (masterDto == null)
            {
            ...
            if (!ucNhapLuuChuyenKhoDetail1.ValidateAll())
            {
            ...
            var detailEntities = ucNhapLuuChuyenKhoDetail1.GetDetails();
            ...
            if (_currentStockInOutMaster == Guid.Empty)
            {
                ...
                _logger.Info("SaveDataAsync: Creating new transfer stock input voucher");
